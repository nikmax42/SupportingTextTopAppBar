...
fun MediumSupportingTextTopBar(
    ...
    titleExpandedTextStyle: TextStyle = MaterialTheme.typography.headlineSmall,
    titleCollapsedTextStyle: TextStyle = MaterialTheme.typography.titleLarge,
    supportingTextExpandedTextStyle: TextStyle = MaterialTheme.typography.labelLarge,
    supportingTextCollapsedTextStyle: TextStyle = MaterialTheme.typography.labelMedium,
    ...
    MediumTopAppBar(
        title = {
            Column(
                ...
                ProvideTextStyle(
                    when (isExpanded) {
                        true -> titleExpandedTextStyle
                        false -> titleCollapsedTextStyle
                    }
                ) {
                    title()
                }
                ProvideTextStyle(
                    when (isExpanded) {
                        true -> supportingTextExpandedTextStyle
                        false -> supportingTextCollapsedTextStyle
                    }
                ) {
                    Row {
                        supportingText()
